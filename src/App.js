...
function App() {
  return (
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h1 class="heading mt-3 mb-3">Features</h1>
        </div>
        ...
        <div class="col-12 col-md-4">
          <div class="vr-cardcontainer d-flex flex-column justify-content-center p-3">
            ...
            <h1 class="cardheading mt-3 mb-0">VR Capability</h1>
            <p class="cardpara">
        ...
        <div class="col-12 col-md-4">
          <div class="vr-cardcontainer d-flex flex-column justify-content-center p-3">
            ...
            <h1 class="cardheading mt-3 mb-0">Interaction</h1>
            <p class="cardpara">
              Interaction refers to the
              <span class="texthighlit">natural interaction</span>
        ...
        <div class="col-12 col-md-4">
          <div class="vr-cardcontainer d-flex flex-column justify-content-center p-3">
            ...
            <h1 class="cardheading mt-3 mb-0">Easy to play</h1>
            <p class="cardpara">
